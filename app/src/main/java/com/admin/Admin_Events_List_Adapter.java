 ...
 */
public class Admin_Events_List_Adapter extends BaseAdapter {
    ...
    public Admin_Events_List_Adapter(Activity a, ArrayList<Events> d) {
        activity = a;
        data = d;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            row = inflater.inflate(R.layout.admin_events_list_adapter, null);
        ...
        holder.txt2.setText(sDate+" || "+sCityName);
        ...
        holder.imgDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((Admin_Home) activity).deleteEvents(position);
            }
        });
        return row;
    }
