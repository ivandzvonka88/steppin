...
public class Dance_Image_Grid_Adapter extends BaseAdapter {

    private static LayoutInflater inflater = null;
    private Activity activity;
    private ArrayList<HashMap<String, Object>> data;

    public Dance_Image_Grid_Adapter(Activity a, ArrayList<HashMap<String, Object>> d) {
        activity = a;
        data = d;
...
//        Picasso.get().load(f).into(holder.img);
        ...
        holder.imgClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((Add_Dance) activity).deleteImage(position);
            }
        });
        return row;
    }
