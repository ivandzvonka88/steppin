...
public class Dance_Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("tel:" + Dance_Fragment.selectedDance.Mobile));
    ...
    public void setData() {
        Details_Banner_Adapter banner_adapter = new Details_Banner_Adapter(this, Dance_Fragment.selectedDance.Images);
        viewPager.setAdapter(banner_adapter);
        worm_dots_indicator.setViewPager(viewPager);

        txtEventsName.setText(Dance_Fragment.selectedDance.Title);
        txtDetails.setText(Dance_Fragment.selectedDance.Details);
        txtLocation.setText(Dance_Fragment.selectedDance.Location);
        String sMobile = "" + Dance_Fragment.selectedDance.Mobile;
    ...
    public void callBanner() {
        if (Dance_Fragment.selectedDance.Images.size() > 1) {
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            if (viewPager.getCurrentItem() == Dance_Fragment.selectedDance.Images.size() - 1) {
